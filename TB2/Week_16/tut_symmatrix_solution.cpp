...
public:
    ...
    void set_elem(int i, int j, int value)
    {
       matrix::set_elem(i, j, value);
       matrix::set_elem(j, i, value);
    }
    ...
    void set_elem_v2(int i, int j, int value)
    {
        ...
        {
          elements[i * num_cols + j] = elements[j * num_cols + i] = value; 
        }
    }
